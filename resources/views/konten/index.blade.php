...
<head>
  ...
  <link href="{{ asset('tempalte-admin/assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
  <link href="{{ asset('tempalte-admin/assets/vendor/simple-datatables/style.css') }}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">DasboardAdmin</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{ asset('template-admin/assets/img/profile-img.jpg') }}" alt="Profile" class="rounded-circle">
  ...
  <h1 class="mb-4">Daftar Konten</h1>

    <a href="{{ route('konten.create') }}" class="btn btn-primary mb-3">Tambah Konten Baru</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('konten.destroy', $konten->id) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
